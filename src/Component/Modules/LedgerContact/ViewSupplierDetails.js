// // src/Pages/Suppliers/ViewSupplierDetails.js
...
// const ViewSupplierDetails =  ({ user }) => {
...
//   if (!supplier) {
//     return <div className="text-center mt-5">No supplier data found.</div>;
//   }
...
//         <h3 className="text-center mb-4">Supplier Details</h3>
  ...
  const renderField = (field) => (
    <div className="col-md-6 mb-3" key={field}>
      ...
      <div className="form-control customer-form-input bg-light">
        {supplier[field] !== null && supplier[field] !== '' ? supplier[field].toString() : 'N/A'}
      </div>
    </div>
  );
